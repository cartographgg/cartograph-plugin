...
public class BackoffConfig
{
    ...
    public void setMaxSeconds(int v) { this.maxSeconds = Math.max(1, v); }

    public int getRetryAfterCapSeconds() { return retryAfterCapSeconds; }
    public void setRetryAfterCapSeconds(int v) { this.retryAfterCapSeconds = Math.max(1, v); }
}
